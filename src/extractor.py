...
class ZipExtractor:
    ...
    def _normalized_member_name(name: str) -> str:
        """Return a canonical UTF-8/Unicode path before touching the filesystem.

        macOS commonly presents filenames in decomposed Unicode form. Keeping ZIP
        members in NFC prevents an archive created elsewhere from producing a
        different-looking container/path when extracted on macOS.
        """
