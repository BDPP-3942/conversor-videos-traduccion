...
def load_settings(config_path: Path | None = None) -> AppSettings:
    ...
    if not path.is_file():
        ...
        settings = AppSettings(
            ...
            whisper_subtitle_split_silence_duration_ms=int(processing.get("whisper_subtitle_split_silence_duration_ms", 750)),
            ...
            local_translation_model_dir=Path(str(processing.get("local_translation_model_dir", "tools/models/translation/madlad400-3b-ct2-int8"))),
            local_translation_model_id=str(processing.get("local_translation_model_id", "cstr/madlad400-3b-ct2-int8")),
            local_translation_model_revision=str(processing.get("local_translation_model_revision", "12eff26f7d93623e2b2d3b5345e5863e14599dae")),
...
def _apply_environment_overrides(settings: AppSettings) -> AppSettings:
    ...
    mapping = {
        ...
        "WHISPER_MODEL": "whisper_model", "WHISPER_DEVICE": "whisper_device", "WHISPER_COMPUTE_TYPE": "whisper_compute_type",
        "WHISPER_BEAM_SIZE": "whisper_beam_size", "WHISPER_VAD_FILTER": "whisper_vad_filter",
        "WHISPER_MIN_SILENCE_DURATION_MS": "whisper_min_silence_duration_ms", "WHISPER_SUBTITLE_SPLIT_SILENCE_DURATION_MS": "whisper_subtitle_split_silence_duration_ms",
        "WHISPER_CONDITION_ON_PREVIOUS_TEXT": "whisper_condition_on_previous_text", "WHISPER_INITIAL_PROMPT": "whisper_initial_prompt",
        "WHISPER_CPU_THREADS": "whisper_cpu_threads", "WHISPER_REPETITION_THRESHOLD": "whisper_repetition_threshold",
        "WHISPER_COMPRESSION_RATIO_THRESHOLD": "whisper_compression_ratio_threshold", "WHISPER_LOG_PROB_THRESHOLD": "whisper_log_prob_threshold",
        "WHISPER_NO_SPEECH_THRESHOLD": "whisper_no_speech_threshold", "WHISPER_MIN_REPETITION_WORDS": "whisper_min_repetition_words",
        "WHISPER_RECOVERY_RETRIES": "whisper_recovery_retries", "WHISPER_RECOVERY_TEMPERATURES": "whisper_recovery_temperatures",
        ...
        "LOCAL_TRANSLATION_MODEL": "local_translation_model", "LOCAL_TRANSLATION_MODEL_DIR": "local_translation_model_dir",
        "LOCAL_TRANSLATION_MODEL_ID": "local_translation_model_id", "LOCAL_TRANSLATION_MODEL_REVISION": "local_translation_model_revision",
        "LOCAL_TRANSLATION_DEVICE": "local_translation_device", "LOCAL_TRANSLATION_COMPUTE_TYPE": "local_translation_compute_type",
        "LOCAL_TRANSLATION_BEAM_SIZE": "local_translation_beam_size", "LOCAL_TRANSLATION_AUTO_DOWNLOAD": "local_translation_auto_download",
        "MAX_ZIP_DEPTH": "max_zip_depth", "MAX_EXTRACTED_FILES": "max_extracted_files", "MAX_EXTRACTED_SIZE_GB": "max_extracted_size_gb",
        "FFMPEG_BIN": "ffmpeg_bin", "FFMPEG_PRESET": "ffmpeg_preset", "FFMPEG_CRF": "ffmpeg_crf", "FFMPEG_AUDIO_BITRATE": "ffmpeg_audio_bitrate",
        "GENERATE_WEBM": "generate_webm", "SECONDARY_VIDEO_EXTENSION": "secondary_video_extension", "SECONDARY_VIDEO_CODEC": "secondary_video_codec",
        "SECONDARY_VIDEO_CRF": "secondary_video_crf", "SECONDARY_VIDEO_MAX_WIDTH": "secondary_video_max_width", "SECONDARY_VIDEO_FPS": "secondary_video_fps",
        "SECONDARY_VIDEO_AUDIO_CODEC": "secondary_video_audio_codec", "SECONDARY_VIDEO_AUDIO_BITRATE": "secondary_video_audio_bitrate", "SECONDARY_VIDEO_CPU_USED": "secondary_video_cpu_used",
        "FFMPEG_TIMEOUT_SECONDS": "ffmpeg_timeout_seconds", "GDRIVE_SOURCE_FOLDER_ID": "source_folder_id", "GDRIVE_TARGET_FOLDER_ID": "target_folder_id",
        "GDRIVE_ARCHIVE_FOLDER_ID": "archive_folder_id", "ORIGINAL_TRANSCRIPT_SUBDIR": "original_transcript_subdir", "GOOGLE_CREDENTIALS_FILE": "google_credentials_file",
        "GOOGLE_TOKEN_FILE": "google_token_file", "RCLONE_CONFIG_FILE": "rclone_config_file", "RCLONE_BINARY_FILE": "rclone_binary_file", "RCLONE_REMOTE": "rclone_remote",
        "PROVIDER_PROFILE_DIR": "provider_profile_dir", "RESUME_ENABLED": "resume_enabled", "NORMALIZE_LEGACY_NAMES": "normalize_legacy_names",
        "RENAME_PROCESSED_DUPLICATES": "rename_processed_duplicates", "AUTOMATIC_OUTPUT_DEDUPLICATION": "automatic_output_deduplication", "MAX_PARALLEL_VIDEOS": "max_parallel_videos",
        "DUPLICATE_NAME_SIMILARITY_THRESHOLD": "duplicate_name_similarity_threshold", "DUPLICATE_DURATION_TOLERANCE_SECONDS": "duplicate_duration_tolerance_seconds",
        "DUPLICATE_VISUAL_SIMILARITY_THRESHOLD": "duplicate_visual_similarity_threshold", "FFMPEG_AVOID_REENCODE": "ffmpeg_avoid_reencode",
        "TTS_ENABLED": "tts_enabled", "TTS_REQUIRED": "tts_required", "TTS_PROVIDER": "tts_provider", "TTS_VOICE": "tts_voice", "TTS_MODEL_PATH": "tts_model_path",
        "TTS_VOICES_PATH": "tts_voices_path", "TTS_SPEED": "tts_speed", "TTS_MAX_SPEED": "tts_max_speed", "TTS_DURATION_TOLERANCE": "tts_duration_tolerance",
        "TTS_SAMPLE_RATE": "tts_sample_rate", "TTS_AUDIO_BITRATE": "tts_audio_bitrate", "TTS_WEBM_AUDIO_BITRATE": "tts_webm_audio_bitrate", "TTS_GENERATE_WEBM": "tts_generate_webm",
        "RUN_LOCK_FILE": "run_lock_file", "AUTO_BOOTSTRAP_RCLONE": "auto_bootstrap_rclone", "AUTO_UPDATE_RCLONE": "auto_update_rclone", "AUTO_TUNE_RESOURCES": "auto_tune_resources",
    }
